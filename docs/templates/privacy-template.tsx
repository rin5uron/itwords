// app/privacy/page.tsx テンプレート
// AdSense要件：プライバシーポリシー（AdSense記載必須）
...
export const metadata: Metadata = {
  ...
  description: '[サイト名]のプライバシーポリシーです。個人情報の取り扱い、Cookieの使用、Google Analytics、アドセンスに関する情報を掲載しています。',
}
...
export default function PrivacyPolicy() {
  return (
    <div className="container">
      ...
      <main>
        <section>
          <p>[サイト名]（以下「当サイト」）は、ユーザーのプライバシーを尊重し、個人情報の保護に努めます。本プライバシーポリシーでは、当サイトにおける個人情報の取り扱いについて説明します。</p>
        </section>
        ...
        <section>
          <h2>9. お問い合わせ</h2>
          <p>本プライバシーポリシーに関するご質問やご意見がございましたら、<Link href="/contact">お問い合わせページ</Link>よりご連絡ください。</p>
        </section>
