...
## 検索数が伸びているページの見直し（SEO・テンプレ）

検索数が増えているページは、**テンプレ準拠**と**1位狙いキーワードの反映**を優先して見直す。

**実施例（2026-01-31）**: リポジトリページ (`/terms/repository`)
- PageSummary を追加（テンプレ必須要素）
- 作成日・更新日を目次の上（date-info-toc）に統一
- SEO: `openGraph.url` 追加、keywords に「リポジトリ フォルダ ディレクトリ 違い」を追加、description を1位狙いキーワードに合わせて調整
- 絵文字（💡）を Font Awesome（fas fa-lightbulb）に統一

参照: `docs/templates/page-template.tsx`、`docs/all-pages-seo-strategy.md`、`docs/templates/checklists/seo-check-sheet.md`

---

## 更新履歴

- 2026-01-31: リポジトリページの見直し（PageSummary・SEO・テンプレ準拠）。検索数伸びページの見直しセクションを追加。テンプレ準拠一覧にリポジトリを追加
