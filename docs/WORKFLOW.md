...
**最終更新**: 2026-02-08（外部リンクルールに合わせて更新。優先順位「公式・公的機関 > Wikipedia > 辞典」を反映。詳細は [Issue #36](https://github.com/rin5uron/itwords/issues/36) 参照）
...
4. **【重要】公式リンクの追加**（**AdSense要件・E-E-A-T対策で必須**）:
   - **必ず入れる**: 優先順位「公式・公的機関 > Wikipedia > 辞典」。社名・機関名が分かるページから1本ずつ（Microsoft Docs、JPCERT等）
