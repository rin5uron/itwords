    ...
    <div className="container">
      ...
      <main>
        ...
        <section>
          ...
          <p>
            下のデモでゼロデイ攻撃のタイムラインを体験できます。攻撃者がどのように脆弱性を発見し、悪用するのかを理解することで、対策の重要性が実感できます。
          </p>

          <h3>デモの使い方</h3>
          <ol>
            <li><strong>「攻撃シミュレーションを開始」ボタンをクリック</strong>：ゼロデイ攻撃のタイムラインが始まります</li>
            <li><strong>各段階を観察</strong>：脆弱性の発見から攻撃、パッチ公開までの流れを確認</li>
            <li><strong>Day 0に注目</strong>：修正パッチが存在しない「防御不可能な期間」を理解しましょう</li>
          </ol>

          <p>
            <strong>ポイント</strong>：ゼロデイ攻撃は、脆弱性が発見されてから修正パッチが公開されるまでの間に行われます。
            この期間は防御側が何もできない「無防備な状態」であり、だからこそ非常に危険なのです。
          </p>
          ...
          <h3>デモから学べること</h3>
          <ul>
            <li>脆弱性発見から攻撃までの時系列</li>
            <li>修正パッチが公開されるまでの「無防備な期間」</li>
            <li>なぜ「ゼロデイ」と呼ばれるのか（Day 0 = 防御日数ゼロ）</li>
            <li>攻撃者が優位に立つ理由</li>
          </ul>
        </section>
