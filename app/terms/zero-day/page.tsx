...
export const metadata: Metadata = {
  ...
  description: 'ゼロデイとは「修正ゼロ日目に攻撃される」が由来の言葉。パッチが出る前に狙われる攻撃の起源・仕組みを、攻撃者目線のシミュレーションで体験しながら理解できます。',
  keywords: ['ゼロデイ攻撃', 'Zero-day', 'ゼロデイ とは', 'ゼロデイ 由来', 'ゼロデイ攻撃 由来', 'ゼロデイ 起源', 'ゼロデイ 意味', 'セキュリティ', '脆弱性', 'サイバー攻撃', 'セキュリティパッチ', 'IT用語 わかりやすく', '体験デモ'],
  openGraph: {
    title: 'ゼロデイ攻撃とは？「0日」の意味と防御法【攻撃者の視点で体験】',
    description: 'ゼロデイとは「修正ゼロ日目に攻撃される」が由来の言葉。パッチが出る前に狙われる攻撃の起源・仕組みを、攻撃者目線のシミュレーションで体験しながら理解できます。',
    type: 'article',
